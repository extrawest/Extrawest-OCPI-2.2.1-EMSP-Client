 ...
 */
@JsonPropertyOrder({
        AuthorizationInfoDto.JSON_PROPERTY_ALLOWED,
        AuthorizationInfoDto.JSON_PROPERTY_TOKEN,
        AuthorizationInfoDto.JSON_PROPERTY_LOCATION,
        AuthorizationInfoDto.JSON_PROPERTY_AUTHORIZATION_REFERENCE,
        AuthorizationInfoDto.JSON_PROPERTY_INFO
})
...
public class AuthorizationInfoDto {
  ...
  private DisplayText info;
    ...
    public AuthorizationInfoDto allowed(AllowedEnum allowed) {

        this.allowed = allowed;
        return this;
  }

    public AuthorizationInfoDto token(TokenDto token) {
  ...
  **/
  ...
  public void setAllowed(AllowedEnum allowed) {
    ...
    public AuthorizationInfoDto location(LocationReferencesDto location) {
    ...
    public LocationReferencesDto getLocation() {
        return location;
    }

    @JsonProperty(JSON_PROPERTY_LOCATION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setLocation(LocationReferencesDto location) {
        this.location = location;
    }

    public AuthorizationInfoDto authorizationReference(String authorizationReference) {

        this.authorizationReference = authorizationReference;
    return this;
  }

    public AuthorizationInfoDto info(DisplayText info) {
  ...
  **/
  ...
  public boolean equals(Object o) {
      ...
      AuthorizationInfoDto authorizationInfoDto = (AuthorizationInfoDto) o;
      return Objects.equals(this.allowed, authorizationInfoDto.allowed) &&
              Objects.equals(this.token, authorizationInfoDto.token) &&
              Objects.equals(this.location, authorizationInfoDto.location) &&
              Objects.equals(this.authorizationReference, authorizationInfoDto.authorizationReference) &&
              Objects.equals(this.info, authorizationInfoDto.info);
  }
  ...
  **/
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder();
      sb.append("class AuthorizationInfoDto {\n");
