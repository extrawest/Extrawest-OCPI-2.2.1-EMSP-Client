...
*Automatically generated by the [OpenAPI Generator](https://openapi-generator.tech)* as a client library for [OCPI Server](https://github.com/extrawest/Extrawest-OCPI-2.2.1-EMSP-Server)

Description
=============

A CPO and EMSP library of Open Charge-Point Interface. This library that is designed to make life easier for those who want to test EMSP application. 

With this library, you can easily get started with the Open Charge-Point Interface by making calls to OCPI EMSP Server API.
